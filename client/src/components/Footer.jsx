            ...
            <div className='grid w-full justify-between sm:flex mid:grid-cols-1'>
                ...
                <Link to='/' className='self-center whitespace-nowrap text-lg
                    ...
                    <span className='px-2 py-1 bg-gradient-to-r from-indigo-500
                     via-purple-500 to-pink-500 rounded-lg text-white'>Vamshi's</span>
                    Blog
                </Link>
                </div>
                <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
                    ...
                    <Footer.LinkGroup col>
                        <Footer.Link
                        href='https://github.com/vamshi-gugulothu'
                        target='_blank'
                        rel='noopener noreferrer'>
                        Github
                        </Footer.Link>
                        <Footer.Link
                        href='https://www.linkedin.com/in/vamhshi-naik'
                        target='_blank'
                        rel='noopener noreferrer'>
                        Linkedin
                        </Footer.Link>
                ...
                <Footer.Copyright
                 href='#'
                  ...
                  <div className='flex gap-6 sm:mt-0 mt-4 sm:justify-center'>
                    ...
                    <Footer.Icon href='https://github.com/vamshi-gugulothu'
                     icon={BsGithub} />
